	...
	return (
		<div className="flex flex-col items-center justify-center w-screen h-screen overflow-hidden bg-gradient-to-tl from-white via-zinc-600/20 to-white">
			...
			<div className="container mx-auto py-8 animate-fade-in">
				...
				<p className="mb-4">We take your privacy seriously and want you to feel comfortable using our game. This policy explains how we collect, use, and share your information, including with our advertising partner, Admob.</p>
				...
				<p className="mb-4">We may use your information in the following ways:</p>
				<ul className="list-disc ml-8 mb-4">
				...
				<p className="mb-4">We do not share your personal information with third parties except as required by law. However, Admob may collect and use your information according to their own privacy policy.</p>
				<h2 className="text-xl font-bold mb-2">Changes to this Policy</h2>
				<p className="mb-4">We reserve the right to modify this policy at any time. Any changes will be posted on our website and will be effective immediately upon posting.</p>
				<h2 className="text-xl font-bold mb-2">Contact Us</h2>
				<p>If you have any questions or concerns about our privacy policy or Admob's privacy practices, please contact us at <a href="mailto:info@yourgame.com">support@talkdy.com</a>.</p>
			</div>
		</div>
	);
}
